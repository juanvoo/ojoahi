...
router.get('/blind-dashboard', isAuthenticated, (req, res) => {
  ...
  res.render('blind-dashboard', { title: 'Dashboard de Usuario Ciego', user: req.session.user });
});
...
router.get('/volunteer-dashboard', isAuthenticated, (req, res) => {
  ...
  res.render('volunteer-dashboard', { title: 'Dashboard de Voluntario', user: req.session.user });
});
